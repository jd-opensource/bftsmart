 ...
 */
public class TRReplyMessage extends TRMessage {
     ...
     * @param
     */
    public TRReplyMessage(int sender, int target, TransactionReplayState state, int startCid, int endCid, int type) {
