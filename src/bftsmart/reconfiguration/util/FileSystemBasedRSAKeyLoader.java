 ...
 */
public class FileSystemBasedRSAKeyLoader implements KeyLoader {
	...
	public PublicKey loadPublicKey(int id) throws Exception {
		...
		if (defaultKeys) {
			return getPublicKeyFromString(FileSystemBasedRSAKeyLoader.DEFAULT_UKEY);
		}
	...
	public PrivateKey loadPrivateKey(int id) throws Exception {
		...
		if (defaultKeys) {
			return getPrivateKeyFromString(FileSystemBasedRSAKeyLoader.DEFAULT_PKEY);
		}
