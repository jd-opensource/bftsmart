...
public class DurableStateLog extends StateLog {
	...
	private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(DurableStateLog.class);
...
//		LOGGER.debug("DurableStateLog#addMessageBatch. consensusId: " + consensusId);
